 ...
 */
export type MemoryType = 'fact' | 'preference' | 'event' | 'relationship' | 'skill' | 'goal' | 'context' | 'feedback';
/**
 * How the memory was acquired
 */
export type MemorySource = 'explicit_statement' | 'inference' | 'correction' | 'observation' | 'external_import';
/**
