 ...
 */
export declare function createEmptyPersona(userId: string, tenantId: string, chatbotId?: string): UserPersona;
/**
 * Probing question categories
 */
export type QuestionCategory = 'professional' | 'communication' | 'preferences' | 'relationships' | 'goals' | 'challenges';
/**
