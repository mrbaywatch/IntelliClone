...
/**
 * Pattern for extracting specific types of information
 */
interface ExtractionPattern {
  type: ConversationInsight['type'];
  patterns: RegExp[];
 ...
 */
const PROFESSIONAL_PATTERNS: ExtractionPattern[] = [
  {
    type: 'fact',
    patterns: [
 ...
 */
const PREFERENCE_PATTERNS: ExtractionPattern[] = [
  {
    type: 'preference',
    patterns: [
 ...
 */
const GOAL_PATTERNS: ExtractionPattern[] = [
  {
    type: 'goal',
    patterns: [
 ...
 */
const CHALLENGE_PATTERNS: ExtractionPattern[] = [
  {
    type: 'challenge',
    patterns: [
 ...
 */
const RELATIONSHIP_PATTERNS: ExtractionPattern[] = [
  {
    type: 'relationship',
    patterns: [
 ...
 */
const STYLE_PATTERNS: ExtractionPattern[] = [
  {
    type: 'style',
    patterns: [
 ...
 */
const ALL_PATTERNS: ExtractionPattern[] = [
 ...
 */
export function extractInsightsFromMessage(message: string): ConversationInsight[] {
 ...
 */
function extractGeneralFacts(message: string): ConversationInsight[] {
  const insights: ConversationInsight[] = [];
 ...
 */
function isUniformative(statement: string): boolean {
  const uninformative = [
 ...
 */
export function analyzeWritingStyle(message: string): {
  formality: number;
  verbosity: number;
  emotionality: number;
  technicality: number;
 ...
 */
export function extractSignaturePatterns(messages: string[]): {
  greetings: string[];
  signoffs: string[];
  phrases: string[];
} {
