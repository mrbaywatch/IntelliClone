 ...
 */
export const DEFAULT_RETRIEVAL_OPTIONS: Required<MemoryRetrievalOptions> = {
  limit: 20,
...
export interface ConsolidationResult {
  ...
  promoted: Array<{ memoryId: string; from: MemoryTier; to: MemoryTier }>;
  
  /** Memories demoted to a lower tier */
  demoted: Array<{ memoryId: string; from: MemoryTier; to: MemoryTier }>;
  
  /** Memories merged together */
  merged: Array<{ sourceIds: string[]; targetId: string }>;
