...
import { UploadDocumentForm } from '~/home/(user)/documents/_components/upload-document-form';
  ...
  return (
    <>
      <HomeLayoutPageHeader
        description={<Trans i18nKey={'documents:documentsTabLabel'} />}
      >
      ...
      <PageBody>
        ...
        >
          {({ data, page, pageCount, pageSize, count }) => {
            if (count === 0 && pageCount === 0) {
              return <UploadDocumentForm accountId={accountId} />;
            }
