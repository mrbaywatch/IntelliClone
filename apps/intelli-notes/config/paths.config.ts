...
const PathsSchema = z.object({
  ...
  app: z.object({
    ...
    // Intelli-Notes specific paths
    accountMeetings: z.string().min(1),
    accountMeetingDetail: z.string().min(1),
    accountActionItems: z.string().min(1),
    accountSearch: z.string().min(1),
  }),
});
...
const pathsConfig = PathsSchema.parse({
  ...
  app: {
    ...
    accountMeetingDetail: `/home/[account]/meetings/[meetingId]`,
    accountActionItems: `/home/[account]/action-items`,
    accountSearch: `/home/[account]/search`,
  },
