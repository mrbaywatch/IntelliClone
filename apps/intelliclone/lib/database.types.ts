...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      can_index_documents: {
        Args: { requested_documents: number; target_account_id: string }
        Returns: boolean
      }
      can_respond_to_message: {
        Args: { target_chatbot_id: string }
        Returns: boolean
      }
      create_invitation: {
      ...
      has_role_on_chatbot: { Args: { chatbot_id: string }; Returns: boolean }
      ...
      reduce_documents_quota: {
        Args: { docs_count: number; target_account_id: string }
        Returns: undefined
      }
