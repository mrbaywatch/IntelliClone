...
const translations = {
  en: {
    ...
    hero: {
      ...
      title2: 'Is AI',
      subtitle: 'We build AI employees that actually remember, learn, and grow with your business. Tailored for Norwegian companies.',
    ...
    cta: {
      ...
      title2: 'Your AI Employee?',
      subtitle: "Let's discuss how a custom AI solution can transform your business.",
      button: 'Get Started',
    ...
    footer: {
      ...
      copyright: '© 2026 IntelliClone. Made with ❤️ in Norway.',
  ...
  no: {
    ...
    hero: {
      badge: 'Skreddersydde AI-løsninger',
      title1: 'Din neste ansettelse',
      title2: 'er AI',
      subtitle: 'Vi bygger AI-ansatte som faktisk husker, lærer og vokser med bedriften din. Skreddersydd for norske virksomheter.',
    ...
    cta: {
      title1: 'Klar til å møte',
      title2: 'din AI-ansatt?',
      subtitle: 'La oss diskutere hvordan en skreddersydd AI-løsning kan transformere din bedrift.',
      button: 'Kom i gang',
      demo: 'Book konsultasjon',
      footnote: 'Gratis konsultasjon. Ingen forpliktelser.',
    },
    footer: {
      ...
      copyright: '© 2026 IntelliClone. Laget med ❤️ i Norge.',
