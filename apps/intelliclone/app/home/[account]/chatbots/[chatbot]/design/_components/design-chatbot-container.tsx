  ...
  useEffect(() => {
    chatBotMessagesStore.saveMessages(
      [
        ...
        {
          parts: [
            { type: 'text', text: `I'd like to know more about your product` },
          ],
          role: 'user',
          id: '2',
        },
        {
          ...
          parts: [
            {
              type: 'text',
              text: `Sure, I'll be happy to help you with that. May I know your name?`,
            },
          ],
        },
        {
